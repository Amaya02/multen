...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="<?php echo base_url('assets/img/logos/logo.jpg'); ?>" alt=""></a>
 ...
 <!-- Signin -->
  ...
  <div class="modal fade" id="demo-2" tabindex="-1">
    ...
    <!-- Plugin JavaScript -->
    <script type="text/javascript" src="<?php echo base_url('assets/vendor/jquery-easing/jquery.easing.js'); ?>"></script>
