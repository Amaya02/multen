...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/img/logos/logo.jpg" alt=""></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">We provide everything you need.</h3>
          </div>
        </div>
        <div class="row text-center">
          <div class="col-md-4">
            ...
            <p class="text-muted">MULTEN provides record management that allows you to access and manage your records easily. It will help to keep up with each piece of information from the moment it was created. Through MULTEN you can update, add, delete, view and print your record.</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading">Website Provider</h4>
            <p class="text-muted">MULTEN provides website. Agencies who does not have their own website can use the website provided by MULTEN.</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading">Record Security</h4>
            <p class="text-muted">MULTEN can make your record safe. You don't have to worry about losing your records. You will be able to secure your records here and will be able to access it using your email address and password.</p>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					...
					<h3 class="section-subheading text-muted">MULTEN is a multi-tenant manpower agency</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<div class="about-col">
					<div class="img">
						 <img class="mx-auto rounded-circle" src="assets/img/about/mission.jpg" alt="">
					</div>
				...
				<div class="col-lg-6">
					<div class="about-col">
					<div class="img">
						 <img class="mx-auto rounded-circle" src="assets/img/about/vision.jpg" alt="">
					</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Our team is composed of 7 BSCS students in TUP</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4">
		  ...
		  <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="assets/img/team/Team4.jpg" alt="">
		  ...
		  <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="assets/img/team/Team5.jpg" alt="">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="assets/img/team/Team6.jpg" alt="">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="assets/img/team/Team7.jpg" alt="">
  ...
  <div class="modal fade" id="demo-2" tabindex="-1">
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; MULTEN 2018</span>
          </div>
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              <li class="list-inline-item">
