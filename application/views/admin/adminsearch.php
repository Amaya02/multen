                                    ...
                                    <table class="table">
										...
										<?php
											...
											echo '	<tr>	
                                                ...
                                                <td>
                                                    <a class="btn btn-info" style="float: right;" href="'.base_url('admin/viewbill/'.$res->userid).'">View Bill</a>
                                                </td>
												<td>
													<a class="btn btn-info" style="float: right;" href="'.base_url('admin/viewclient/'.$res->userid).'">View Profile</a>
												</td>
											</tr>
											';
											}
