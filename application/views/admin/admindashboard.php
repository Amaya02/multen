                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart clients">
                            <div class="card-header">
                                <h2 class="card-title">Clients
								<?php
								$file = $count; //Let say If I put the file name Bang.png
								if($file>0){
									echo '('.$file.')';
								}
								?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-chart">
                            <div class="card-body">
                                <p><b>First Name:</b> <?php echo $metadata['fname']; ?></p> 
								<p><b>Last Name:</b> <?php echo $metadata['lname']; ?></p>
								<p><b>Username:</b> <?php echo $metadata['username']; ?></p>
								<p><b>Email Address:</b> <?php echo $metadata['email']; ?></p><br/>
								<p><b>Address:</b> <?php echo $metadata['address']; ?></p>
								<p><b>City:</b> <?php echo $metadata['city']; ?></p>
								<p><b>State:</b> <?php echo $metadata['state']; ?></p>
								<p><b>Zip Code:</b> <?php echo $metadata['zipcode']; ?></p>
								<p><b>Contact Number:</b> <?php echo $metadata['cnum']; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
