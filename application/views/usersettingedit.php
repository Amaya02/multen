                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" value="amayalelis@yahoo.com" required />
											</div>
                                        </div>
                                    ...
                                    <div class="row">
									    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Company Name" value="mayacorp" required />
											</div>
                                        </div>
                                    </div>
                                    <div class="row">
								...
								<a href="<?php echo base_url(); ?>setting"><button type="button" style="float: right;" class="btn btn-info">Back</button></a>
                            </div>
                        </div>
                    </div>
                </div>
