    ...
    -->
                ...
                <ul class="nav">
					...
					<li> 
						...
						<ul class="sidenav-second-level collapse" id="collapseComponents">
							...
							<li class="active"><a href="<?php echo base_url(); ?>user/selected">Selected</a></li>
        ...
        <div class="main-panel">
            ...
            <div class="content">
				...
				<a type="button" style="float: left;" class="btn btn-submit" href="<?php echo base_url()?>pdf/pdfselect">Print List</a>
            </div>
    ...
    <div class="modal fade" id="preModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary" href="<?php echo base_url(); ?>user/preselection">Pre-Select</a>
          </div>
        </div>
      </div>
    </div>
