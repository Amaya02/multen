                                    ...
                                    <div class="row">
									    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Company Name" value="" disabled="" />
											</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <input type="text" class="form-control" disabled="" placeholder="Address" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 px-1">
                                            <div class="form-group">
                                                <label>State</label>
                                                <input type="text" class="form-control" disabled="" placeholder="State" value="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                <label>Zip Code</label>
                                                <input disabled="" type="text" name="cnumber" placeholder="Phone Number" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input disabled="" type="email" name="conemail" placeholder="Email Address" class="form-control" value="" />
                                            </div>
                                        </div>
                                    </div>
									
                                </form>
								<a href="<?php echo base_url(); ?>employer/editaccount" style="float: right;" class="btn btn-info">Edit Account</a>
                            </div>
                        </div>
                    </div>
                 </div>
