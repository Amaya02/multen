                 ...
                 <div class="row">
                   <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form autocomplete="off" enctype="multipart/form-data" role="form" method="post" action="<?php echo base_url('employer/updatejob/'.$pos[0]['posid']); ?>" onsubmit="return(validate());">
                                    <div class="row">
										<div class="col-md-12">
                                            <div class="form-group">
                                                <label>Position</label><span style="color: red"> *</span>
                                                <input required type="text" name="position" class="form-control" placeholder="Position" value="<?php echo $pos[0]['position']; ?>" />
                                            </div>
                                        </div>
									</div>
									<div class="row">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <br/>
													...
													foreach($gen as $gends){
														echo "<option value='".$gends."'"; if (!empty($pos[0]['status']) && $pos[0]['status'] == $gends)  echo 'selected = "selected"'; echo">{$gends}</option>";
													}
													echo '</select>';?>
                                            </div>
                                        </div>
