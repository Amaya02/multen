                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form autocomplete="off" enctype="multipart/form-data" role="form" method="post" action="<?php echo base_url(); ?>applicant/saveaddexp" onsubmit="return(validate());">
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Company</label><span style="color: red"> *</span>
                                                <input required type="text" name="company" class="form-control" placeholder="Company" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="job" class="form-control" placeholder="Job" value="" />
                                            </div>
                                        </div>
                                    </div>
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                 ...
                                                 <input required type="text" name="years" placeholder="Years" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="" />
                                            </div>
                                        </div>
                                    </div>
