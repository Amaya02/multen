                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title">Add Skill</h5>
                            </div>
                            <div class="card-body">
                                <form autocomplete="off" enctype="multipart/form-data" role="form" method="post" action="<?php echo base_url(); ?>applicant/saveaddskill" onsubmit="return(validate());">
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Skill</label><span style="color: red"> *</span>
                                                <input required type="text" name="skill" class="form-control" placeholder="Skill" value="" />
                                            </div>
                                        </div>
                                    </div>
